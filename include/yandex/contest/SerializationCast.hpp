...
struct Reader {
  ...
  static void deserialize(const String &s, T &obj) {
    std::basic_istringstream<typename String::value_type,
...
using BinaryWriter = Writer<boost::archive::binary_oarchive>;
using BinaryReader = Reader<boost::archive::binary_iarchive>;
